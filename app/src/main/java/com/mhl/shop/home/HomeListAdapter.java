...
public class HomeListAdapter extends BaseAdapter {
	private List<Home.RecommendBean> datas = new ArrayList<>();
	private Context context;

	public HomeListAdapter(Context context, List<Home.RecommendBean> datas){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position * 2 + 1 < datas.size()){
			item1 = String.valueOf(datas.get(position * 2).getGoodsTitle());
			item2 = String.valueOf(datas.get(position * 2 + 1).getGoodsTitle());
