 ...
 * 描述：
 */
public class PasswordDialogView extends Dialog implements View.OnClickListener
{
    private String				msg;
    private TextView tv;
    ...
    public PasswordDialogView(Context context, int theme, String msg, OnYesButtonListener onYesButtonListener, OnNoButtonListener onNoButtonListener) {
        super(context, theme);
        this.msg = msg;
        this.onYesButtonListener = onYesButtonListener;
        this.onNoButtonListener = onNoButtonListener;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.password_img_dialog);
