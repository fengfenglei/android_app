...
public class ClistViewNoScroll extends LinearLayout implements View.OnClickListener {
    ...
    public ClistViewNoScroll(Context context, AttributeSet v_attrs){
    ...
    public void refreshListView(){
        ...
        for (int i = 0; i < count; i++) {
            ...
            layout_line.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, m_lineHeight));
