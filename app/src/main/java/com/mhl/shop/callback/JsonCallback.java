...
import com.mhl.shop.login.SimpleResponse;
import com.mhl.shop.main.MyApplication;
import com.mhl.shop.utils.Convert;
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (rawType == Void.class) {
            ...
            if (code == 200) {
                ...
                throw new IllegalStateException(lzyResponse.info);
//                throw new IllegalStateException("错误代码：" + code + "，错误信息：" + lzyResponse.info);
//                if(!TextUtils.isEmpty(lzyResponse.info)){
//                    Toast.makeText(this, lzyResponse.info.toString(), Toast.LENGTH_SHORT).show();
//                }
