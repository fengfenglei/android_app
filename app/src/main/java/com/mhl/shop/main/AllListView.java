 ...
 * 描述：
 */
public class AllListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private setLOnRefreshListener mOnlRefreshListener;
    ...
    public interface setLOnRefreshListener{
        void onLoadingMore();
    }
    public void setLOnRefreshListener(setLOnRefreshListener onRefreshListener){
        mOnlRefreshListener = onRefreshListener;
    }
    ...
    public void onScrollStateChanged(AbsListView absListView, int scrollState) {
        if (scrollState == SCROLL_STATE_IDLE || scrollState == SCROLL_STATE_FLING) {
            ...
            if (isScrollToBottom && !isLoadingMore) {
                ...
                if (mOnlRefreshListener != null) {
                    mOnlRefreshListener.onLoadingMore();
                }
            }
        }
    }
