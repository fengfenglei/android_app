 ...
 * 描述：Fragment的封装
 */
public class MyBaseRegistFragment extends Fragment {
    ...
    protected void handleError(Call call, Response response, Exception e) {
        if(response!=null) {
            if (response.code() == 401 || e.getMessage().equals("401")) {   //刷新token
                OkGo.post(Urls.TOKEN)//
                        ...
                        .execute(new StringDialogCallback(getActivity(), true) {
                            ...
                            public void onSuccess(String s, Call call, Response response) {
                                ...
                                SharedPreferencesUtils.setParam(getActivity().getApplicationContext(), SharedPreferencesUtils.isLogin, true);
                            }
...
//                            startActivity(login);
                ...
                T.showShort(getActivity(), "链接超时，请重试！");
            } else {
