 ...
 * 描述：Fragment的封装
 */
public class MyBaseAddressFragment extends Fragment {
                        ...
                        .execute(new StringDialogCallback(getActivity(), true) {
                            ...
                            public void onSuccess(String s, Call call, Response response) {
                                ...
                                if(TextUtils.isEmpty(token.getAccess_token())){
                                    //刷新失败时跳转登陆界面重新登陆
                                    T.showShort(getActivity(), "刷新失败时跳转登陆界面重新登陆");
                                    return;
                                }
                                ...
                                SharedPreferencesUtils.setParam(getActivity(), SharedPreferencesUtils.isLogin, true);
                            }
                            @Override
