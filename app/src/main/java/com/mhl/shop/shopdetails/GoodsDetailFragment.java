...
public class GoodsDetailFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tv_goods_detail, tv_goods_config, tv_goods_three;
...
//    public GoodsDetailFragment(String goodsid) {
//        mgoodsid=goodsid;
//    }
    @Override
    ...
    private void initView() {
        ...
        tv_goods_three = (TextView) rootView.findViewById(R.id.tv_goods_three);
        ...
        tabTextList.add(tv_goods_three);
