 ...
 */
public class GoodsInfoWebFragment extends MyBaseRegistFragment {
    public ItemWebView mWebView;
    private WebSettings webSettings;
    private LayoutInflater inflater;
    private String mgoodsId;
    @SuppressLint("ValidFragment")
    public GoodsInfoWebFragment(String goodsid) {
        mgoodsId=goodsid;
    }
    ...
    public void initWebView(View rootView) {
        ...
        String url = Urls.URL_BASE+"/goods-detail-recommend.html?goodsId="+mgoodsId;
