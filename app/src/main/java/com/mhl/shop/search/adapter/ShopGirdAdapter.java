...
public class ShopGirdAdapter extends BaseAdapter {
	private List<ShopResult.GoodsInfosBean> datas = new ArrayList<>();
	private Context context;

	public ShopGirdAdapter(Context context, List<ShopResult.GoodsInfosBean> datas){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position * 2 + 1 < datas.size()){
			...
			goodsTitle1 = String.valueOf(datas.get(position * 2).getGoodsName());
			goodsTitle2 = String.valueOf(datas.get(position * 2 + 1).getGoodsName());
...
//			hodler.textView1.setText(item1);
			...
			Glide.with(context).load(Urls.URL_PHOTO+"/file/v3/download-"+icon1+"-400-400.jpg").placeholder(R.drawable.icon_bg).into(hodler.icon1);
...
//			hodler.textView2.setText(item2);
			hodler.goodsTitle2.setText(goodsTitle2);
			...
			Glide.with(context).load(Urls.URL_PHOTO+"/file/v3/download-"+icon2+"-400-400.jpg").placeholder(R.drawable.icon_bg).into(hodler.icon2);
