...
public class NoShopListAdapter extends BaseAdapter {
	private  List<ShopResult.ChoicenesssBean> datas = new ArrayList<>();
	private Context context;

	public NoShopListAdapter(Context context, List<ShopResult.ChoicenesssBean> datas){
...
//			hodler.textView2.setText(item2);
			...
			Glide.with(context).load(Urls.URL_PHOTO+"/file/v3/download-"+icon1+"-400-400.jpg").into(hodler.icon2);
